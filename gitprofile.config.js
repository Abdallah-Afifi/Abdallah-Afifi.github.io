...
const config = {
  github: {
    username: 'Abdallah-Afifi', // Your GitHub org/user name. (Required)
  ...
  social: {
    linkedin: 'abdallah-afifi26',
    twitter: 'Abdallahtech22',
 //   facebook: '',
 //   instagram: '',
...
//  experiences: [
  ...
  education: [
    {
      ...
      degree: 'Bachelor\'s of Computer Science with a minor in Math',
      from: '2022',
      to: '2026',
 ...
 // ],
  ...
  //},
  googleAnalytics: {
    id: 'G-VF5Z7XFMNX', // GA3 tracking id/GA4 tag id UA-XXXXXXXXX-X | G-XXXXXXXXXX
  },
